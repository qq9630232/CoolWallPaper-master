 ...
 * StatusBarUtil 1.5.1 以后可更新
 */
public class StatusBarUtil {

    public static final int DEFAULT_STATUS_BAR_ALPHA = 112;
    private static final int FAKE_STATUS_BAR_VIEW_ID = R.id.elita_statusbarutil_fake_status_bar_view;
    private static final int FAKE_TRANSLUCENT_VIEW_ID = R.id.elita_statusbarutil_translucent_view;
...
//    }
     ...
     * @param context
     */
    public static void setViewHeightStatusHeight(View view, Context context, int color) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
    ...
    public static void setViewMargin(View view, Context context) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (viewParams instanceof LinearLayout.LayoutParams) {
                LinearLayout.LayoutParams linearLayoutParams = (LinearLayout.LayoutParams) viewParams;
                linearLayoutParams.topMargin = StatusBarUtil.getStatusBarHeight(context);
                view.setLayoutParams(linearLayoutParams);
            } else if (viewParams instanceof RelativeLayout.LayoutParams) {
                RelativeLayout.LayoutParams relativeLayoutParams = (RelativeLayout.LayoutParams) viewParams;
                relativeLayoutParams.topMargin = StatusBarUtil.getStatusBarHeight(context);
