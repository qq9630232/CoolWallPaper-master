...
import com.coolwallpaper.BmobCrash;
...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    private void uploadExceptionToServer(Throwable throwable) {
        final boolean exce = false;
        BmobCrash bmobCrash = new BmobCrash();
        bmobCrash.setCrash(throwable.getMessage());
        bmobCrash.save(mContext, new SaveListener() {
            @Override
